...
import 'package:mobile_flutter_uploader/mobile_flutter_uploader_platform_interface.dart';
import 'package:mobile_flutter_uploader/mobile_flutter_uploader_method_channel.dart';
...
void main() {
  final MobileFlutterUploaderPlatform initialPlatform = MobileFlutterUploaderPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockMobileFlutterUploaderPlatform fakePlatform = MockMobileFlutterUploaderPlatform();
